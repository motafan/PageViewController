...
// MARK: -  PageTabBarItem
class PageTabBarItem: UICollectionViewCell {
    
    /// 重用标识
    static var reuseID: String {
        return "\(PageTabBarItem.self)"
    }
    ...
    func configItem(itemModel: PageTabBarItemModel) {
